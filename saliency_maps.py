...
#    test_model_path = '/data/pruiz/PLA-Net/LM/BINARY_'+ target
    test_model_path = '/media/SSD5/pruiz/2022-2023/PLA-Net/log/ISBI/PLA-Net/BINARY_'+ target
...
#    test_model_path4 = test_model_path+'/Fold4/model_ckpt/BS_2560-NF_full_valid_best.pth'
    ...
    test_model_path1 = test_model_path+'/Fold1/Best_Model.pth' #/Checkpoint__Best.pth'
    test_model_path2 = test_model_path+'/Fold2/Best_Model.pth' #/Checkpoint__Best.pth'
    test_model_path3 = test_model_path+'/Fold3/Best_Model.pth' #/Checkpoint__Best.pth'
    test_model_path4 = test_model_path+'/Fold4/Best_Model.pth' #/Checkpoint__Best.pth'
